package com.goudar.CoffeeShopApplication.ordermanagement.controllers;
...
import com.goudar.CoffeeShopApplication.ordermanagement.services.EmailService;
import com.goudar.CoffeeShopApplication.ordermanagement.services.IReportGenerator;
...
public class OrderController {
    ...
    @ApiOperation(value = "List All Orders According to the date,week,month or year", response = Customer.class, tags = {"Order"})
    @ApiResponses(value = {
